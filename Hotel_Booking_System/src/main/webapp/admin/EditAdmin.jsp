...
<!-- Login Page -->
                  ...
                  <form action="../updateAdmin"  method="post"> 
                      <div class="row mb-3">
                          ...
                          <input hidden value="<%=admin.getAdminId()%>" name="id">
                              ...
                              <input type="text" class="form-control"  placeholder="First Name" required name="firstName" value="<%=admin.getFirstName() %>" >
                          </div>
                          <div class="col">
                              <label for="lastname" class="form-label">Last Name:</label>
                              <input type="text" class="form-control" placeholder="Last Name "  required  name="lastName" value="<%= admin.getLastName()%>">
                          </div>
                      </div>
                     <!--  <div class="row mb-3">
                          <div class="col">
                      ...
                      <div class="row mb-3">
                          <div class="col">
                              ...
                              <input type="email" class="form-control"  placeholder="Email"  required name="email"  value="<%=admin.getEmail()%>">
                          </div>
                          <div class="col">
                            <label for="password" class="form-label">Password :</label>
                            <input type="password" class="form-control"  required placeholder="Password" name="password" value="<%=admin.getPassword()%>">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col">
                            <label for="contact" class="form-label">Mobile Number :</label>
                            <input type="number" class="form-control"  placeholder="Mobile Number" required name="contact" value="<%= admin.getMobile()%>">
                        </div>
                           <div class="col">
    	...
    	<center> <h2 style="color: red;">Error While Fetching Admin Details</h2></center>
    	<%} %>
</body>
</html>