...
<div>
 ...
 <%-- <%
    	String message2 = (String) request.getParameter("msg");
    	if( message2 != null)
    	{
    %>
    ...
    <div style="color: black">
		...
		%>
         ...
         <br> 
         <br>
          <h2 style="color: white;"> <span style="background-color: black;"><%=customer.getFirstName()+" "+customer.getLastName()%></span> </h2>
